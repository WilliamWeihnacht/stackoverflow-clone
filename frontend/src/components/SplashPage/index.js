    ...
    return (
        <div id='splash-black-box'>
            ...
            <div id='title-container'>
                <h1 id='splash-title'>Every<br></br><div id='splash-title-em'>hacker<br></br></div> has a tab open to Hack Overload</h1>
            </div>
